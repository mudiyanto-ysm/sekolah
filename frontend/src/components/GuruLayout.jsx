...
const navItems = [
  { to: '/guru', label: 'Ringkasan', end: true },
  { to: '/guru/nilai', label: 'Input Nilai' },
  { to: '/guru/absensi', label: 'Absensi' },
];

function GuruLayout({ title, children }) {
    ...
    <div className="min-h-screen bg-slate-50 flex">
      <aside className="w-56 bg-white border-r border-slate-200 flex flex-col shrink-0">
        <div className="px-5 py-5 border-b border-slate-100">
          ...
          <p className="text-sm font-semibold text-slate-800">Panel Guru</p>
        </div>
